...
FOUNDRY_MODEL_DEPLOYMENTS = os.environ.get(
    "FOUNDRY_MODEL_DEPLOYMENTS", FOUNDRY_MODEL_DEPLOYMENT
)
FOUNDRY_VISION_MODEL_DEPLOYMENT = os.environ.get(
    "FOUNDRY_VISION_MODEL_DEPLOYMENT", "gpt-4o"
)
